...
**** 3.2.22. Generacion del compuesto
...
de $F$ contiene a todo elemento de $E$ y de $F$, por lo que es
sistema de generadores de $EF$.
...
**** 3.2.27. Una extensión algebraica y finitamente generada es finita
...
subcuerpo de $F$. Llamado *clausura algebraica relativa* de $F$.
...
conservaría al apliacr el isomorfismo y tendríamos 
...
**** 4.1.10. Cuerpo de descomposición de una torre
...
En otro caso, por Kronecker, tenemos que existe una extensión
...
**** 4.1.13. Los cuerpos de descomposición son isomorfos
...
**** 4.1.25. Unicidad (esencial) del cuerpo de descomposición
