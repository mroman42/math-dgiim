...
una *transformación natural composición* $\tau \circ \sigma$.
...
Donde cada componente se crea aprovechando la siguiente igualdad:
...
****** Notación
En las ocasiones en las que sea obvio, omitiremos el símbolo explícito
de composición.

***** Categoría de los funtores
Dadas ${\cal A},{\cal B}$ categorías, los funtores entre ellas forman una categoría
que llamaremos $Funct({\cal A},{\cal B})$ y que tiene como morfismos a las 
transformaciones naturales con la composición vertical:
...
Notamos al par de funtores adjuntos como $F \dashv G$.

***** Condiciones de naturalidad
Las condiciones de naturalidad de esa familia de isomorfismos equivalenx
...
cuando se fija un argumento. Es decir, hay dos isomorfismos naturales:
 ...
 - $Hom(F-,b) \Longrightarrow Hom(-,Gb)$
 - $Hom(Fa,-) \Longrightarrow Hom(a,G-)$
