...
*** Clasificación de unidades y divisores de cero en dimensión finita :drill:
Enunciar el teorema de clasificación en unidades y divisores de
cero en un álgebra de dimensión finita.
