...
**** Characterization of universal arrows as natural bijections
...
natural in both $x\in X$ and $a \in A$.
...
Each adjunction is completely determined by any of
 ...
 5) functors $F,G$, with units and counits satisfiying the triangle identities.
