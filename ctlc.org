...
* Mikrokosmos
*Mikrokosmos* is a lambda calculus interpreter written in the purely
functional programming language [[https://www.haskell.org/][Haskell]] cite:hudak07_haskell. It aims
to provide students with a tool to learn and understand lambda
calculus.
