...
:DRILL_EASE: 3.0
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2018-01-22 Mon 23:14]
:END:
...
*** Monoidal category: diagrams                                     :drill:
Diagrams of a monoidal category, where
...
**** Diagrams
A monoidal category has isomorphisms such that the pentagonal diagram
commutes
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2018-01-12 Fri 16:24]
:END:
...
:DRILL_EASE: 2.36
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2018-01-22 Mon 23:43]
:END:
Definition of compact space by open covers.
...
:DRILL_EASE: 2.6
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2018-01-22 Mon 23:36]
:END:
...
**** Statement
In a measure space, given $\left\{ f_n \right\}$ a sequence of $\Sigma,{\cal B}_{\mathbb{R}}\text{-measurable}$ non-negative
functions $f_n \colon X \to [0,+\infty]$; taking $f(x) = \liminf_{n\to \infty} f_n(x)$; we have that
$f$ is $\Sigma,{\cal B}_{\mathbb{R}}\text{-measurable}$ and
