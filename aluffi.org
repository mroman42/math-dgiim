...
los complejos de cocadenas en $A$ y como morfismos entre dos cocadenas,
$Hom(M^\bullet,N^\bullet)$, los diagramas conmutativos entre ellas. Por ejemplo:
...
Esta es una categoría abeliana.
